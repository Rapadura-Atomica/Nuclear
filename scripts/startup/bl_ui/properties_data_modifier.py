...
class OBJECT_MT_modifier_add_generate(ModifierAddMenu, Menu):
    ...
    def draw(self, context):
        ...
        if ob_type == 'GREASEPENCIL':
            ...
            self.operator_modifier_add(layout, 'GREASE_PENCIL_MASK')
...
class OBJECT_MT_modifier_add_deform(ModifierAddMenu, Menu):
    ...
    def draw(self, context):
        ...
        if ob_type == 'GREASEPENCIL':
            ...
            self.operator_modifier_add(layout, 'GREASE_PENCIL_CONTOUR')
            self.operator_modifier_add(layout, 'GREASE_PENCIL_CURVE')
