                   ...
                   const State &state) final
  {
    ...
    switch (ob_ref.object->type) {
      ...
      case OB_GREASE_PENCIL:
        /* Nuclear: the outline traces the selected piece, so it follows the artwork the artist
         * sees -- layers that draw nothing (fully transparent, or entirely eaten by their own
         * mask) must not balloon it past the drawing. */
