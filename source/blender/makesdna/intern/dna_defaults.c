...
SDNA_DEFAULT_DECL_STRUCT(GreasePencilCurveModifierData);
SDNA_DEFAULT_DECL_STRUCT(GreasePencilMaskModifierData);
...
SDNA_DEFAULT_DECL_STRUCT(GreasePencilContourModifierData);
...
const void *DNA_default_table[SDNA_TYPE_MAX] = {
    ...
    SDNA_DEFAULT_DECL(GreasePencilContourModifierData),
    ...
    SDNA_DEFAULT_DECL(GreasePencilCurveModifierData),
    SDNA_DEFAULT_DECL(GreasePencilMaskModifierData),
